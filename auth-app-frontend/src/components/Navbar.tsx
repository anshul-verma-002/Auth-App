...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-col md:flex-row justify-around items-center md:h-14 gap-3 md:gap-0 py-2 md:py-0 dark:bg-slate-950 bg-white border-b dark:border-slate-800 border-slate-200 shadow-sm pt-4">
      {/* Logo */}
