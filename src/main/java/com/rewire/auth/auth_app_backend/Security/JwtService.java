...
import com.rewire.auth.auth_app_backend.Models.Role;
...
public class JwtService {
    ...
    public JwtService(
            ...
            @Value("${spring.security.jwt.access-tls-seconds}")long accessTtlSeconds,
            @Value("${spring.security.jwt.refresh-tls-seconds}") long refreshTtlSeconds,
    ...
    public String getEmail(String email){
        Claims c = parse(email).getPayload();
